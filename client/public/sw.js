...
// Background sync for offline emotion data
...
function doBackgroundSync() {
  // Handle offline emotion data sync when connection is restored
...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.text() : 'Baby monitoring alert',
    icon: '/logo192.png',
    badge: '/favicon.ico',
    vibrate: [100, 50, 100],
    data: {
